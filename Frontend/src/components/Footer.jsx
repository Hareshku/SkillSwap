        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/hareesh.kumar.830359" className="text-gray-400 hover:text-primary-400 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/haresh-kumar-9bb353251/" className="text-gray-400 hover:text-primary-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/discover" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Discover
                </Link>
              </li>
              <li>
