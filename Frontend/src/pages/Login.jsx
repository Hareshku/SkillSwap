          ...
          <div className="mb-6">
            <div className="flex rounded-lg bg-gray-100 p-1">
              <button
                ...
                className={`flex-1 py-2 px-4 text-sm font-medium rounded-md transition-colors ${loginType === "user"
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 text-sm font-medium rounded-md transition-colors ${loginType === "admin"
                  ? "bg-white text-primary-600 shadow-sm"
                  : "text-gray-500 hover:text-gray-700"
                  }`}
              >
