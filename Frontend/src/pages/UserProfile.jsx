...
const UserProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto bg-white shadow-lg sm:mx-4 lg:mx-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-green-500 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
            <div className="flex flex-col sm:flex-row items-center sm:space-x-4 lg:space-x-8 space-y-4 sm:space-y-0">
              {/* Profile Picture */}
              <div className="relative w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-full border-4 border-white overflow-hidden shadow-lg bg-white flex-shrink-0">
              ...
              <div className="text-white text-center sm:text-left">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2">{profileData?.full_name || 'User Name'}</h1>
                <p className="text-lg sm:text-xl opacity-90 mb-1">{profileData?.profession || 'Professional'}</p>
                <p className="text-base sm:text-lg opacity-80 mb-2 sm:mb-4">{profileData?.institute || 'Institute'}</p>

                {/* Rating */}
                <div className="flex items-center justify-center sm:justify-start space-x-2">
                  <Rating rating={userRating} size="lg" />
                  <span className="text-white opacity-90 text-sm sm:text-base">
            ...
            <div className="flex justify-center lg:justify-end space-x-3">
              <a
                ...
                className="w-10 h-10 sm:w-12 sm:h-12 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all"
                title="LinkedIn"
              >
        ...
        <div className="bg-gray-50 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-gray-200">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex lg:space-x-4 gap-3 lg:gap-0">
            {/* Connection Button */}
            {connectionStatus?.status === 'none' || connectionStatus?.canSendRequest ? (
              <button
                onClick={() => setShowConnectionModal(true)}
                className="bg-green-600 text-white px-3 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center space-x-1 sm:space-x-2 font-semibold text-sm sm:text-base lg:text-lg lg:min-w-[140px]"
              >
              ...
              <button
                disabled
                className="bg-yellow-500 text-white px-3 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg cursor-not-allowed flex items-center justify-center space-x-1 sm:space-x-2 font-semibold text-sm sm:text-base lg:text-lg lg:min-w-[140px]"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                disabled
                className="bg-green-500 text-white px-3 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg cursor-not-allowed flex items-center justify-center space-x-1 sm:space-x-2 font-semibold text-sm sm:text-base lg:text-lg lg:min-w-[140px]"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="bg-blue-600 text-white px-3 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center space-x-1 sm:space-x-2 font-semibold text-sm sm:text-base lg:text-lg lg:min-w-[140px]"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="bg-yellow-600 text-white px-3 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg hover:bg-yellow-700 transition-colors flex items-center justify-center space-x-1 sm:space-x-2 font-semibold text-sm sm:text-base lg:text-lg lg:min-w-[140px]"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="bg-red-600 text-white px-3 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg hover:bg-red-700 transition-colors flex items-center justify-center space-x-1 sm:space-x-2 font-semibold text-sm sm:text-base lg:text-lg lg:min-w-[140px] col-span-2 sm:col-span-1"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="flex flex-col lg:flex-row lg:space-x-8 space-y-8 lg:space-y-0">
            ...
            <div className="flex-1">
              ...
              <div className="mb-6 sm:mb-8">
                <div className="bg-gray-50 p-4 sm:p-6 rounded-lg">
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6">Reviews & Rating</h2>
